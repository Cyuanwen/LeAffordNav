'''
add by cyw
copy from src/home_robot/home_robot/navigation_policy/object_navigation/objectnav_frontier_exploration_policy.py
backup in 2024-05-04

这里有一些不完全的修改，但基本为原来的代码
'''
