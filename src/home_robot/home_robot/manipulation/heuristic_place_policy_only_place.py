...
'''
@cyw copy from src/home_robot/home_robot/manipulation/heuristic_place_policy.py
仅仅在place 任务上使用，place任务的观测和原始任务有些不同，因此需要对代码进行调整
'''
import random
...
class HeuristicPlacePolicy_OnlyPlace(nn.Module):
    """
