...
class TopDownMap(Measure):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # @cyw
        self.meters_per_pixel = getattr(config,"meters_per_pixel",None)
        ###
        super().__init__()
    ...
    def get_original_map(self):
        # @cyw 增加了参数 meters_per_pixel=self.meters_per_pixel
    ...
    def get_polar_angle(agent_state):
        ...
        phi = cartesian_to_polar(heading_vector[2], -heading_vector[0])[1]
        # @cyw 相当于计算 heading_vector 和 -y轴的夹角，总体来看，算出来的就是坐标轴的旋转
        return np.array(phi)
