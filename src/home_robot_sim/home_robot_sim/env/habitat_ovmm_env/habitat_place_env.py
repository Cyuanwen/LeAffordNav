...
'''
@cyw
modify from src/home_robot_sim/home_robot_sim/env/habitat_ovmm_env/habitat_ovmm_env.py
一下键值 env 的观测里面没有，尽管在配置文件里设置了，仍然没有，有些奇怪
      # - start_receptacle
      # - robot_start_gps
      # - robot_start_compass
      # - object_segmentation
...
class HabitatPlaceEnv(HabitatEnv):
    joints_dof = 7
    # # @cyw
    # joints_dof = 5
