FROM ovmm_baseline_submission_v5:homerobot-ovmm-challenge-2023-ubuntu20.04
...
# ADD scripts/submission_cyw_multiprocess_escyolo.sh /home-robot-v1/home-robot/submission.sh
...
ENV HOME_ROBOT_ROOT "/home-robot-v1/home-robot/"
...
CMD /bin/bash -c "\
    ...
    && bash projects/habitat_ovmm/scripts/submission_cyw_multiprocess_escyolo_gaze.sh $LOCAL_ARGS \
    "
