...
for ((i=0; i<10; i++)); do
    ...
    python projects/habitat_ovmm/eval_baselines_agent.py --evaluation_type $AGENT_EVALUATION_TYPE  --agent_type gaze_place --baseline_config_path cyw/configs/agent/esc_yolo_gaze_place_cyw_agent.yaml --from_index $start --to_index $end $@ &
